...
- (IBAction)didPressedAccount:(id)sender {
    AccountViewController *coolViewCtrlObj=[[AccountViewController alloc] initWithNibName:@"AccountViewController" bundle:nil];
    [self.navigationController pushViewController:coolViewCtrlObj  animated:YES];

}
- (IBAction)điPressedMember:(id)sender {
